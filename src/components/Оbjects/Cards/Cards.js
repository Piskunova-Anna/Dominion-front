...
function Card(props) {
  ...
  return (
    <article className="object">
      ...
      <Link to={`/${props.card._id}`} className='object__link'>
      ...
      <ul className="object__about">
        ...
        <li className="object__name object_a">М.<p className="object__block object__metro">{props.card.metro}</p></li>
        <li className="object__name object_b">Этаж:<p className="object__block object__level">{props.card.floor}</p></li>
        <li className="object__block object__area"><p className="object__name">{props.card.totalarea} кв.м.</p></li>  
        <li className="object__block object__address">{props.card.adress}</li>
        <li className="object__name object_c">район:<p className = "object__block">{props.card.district}</p></li>  
        <li className="object__name object_d">Кол-во комнат:<p className="object__block object__num">{props.card.rooms}</p></li>
